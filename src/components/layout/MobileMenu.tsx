  ...
  return (
    <div className="fixed inset-0 z-50 lg:hidden">
      ...
      <div className="fixed inset-y-0 left-0 w-80 bg-white shadow-xl overflow-y-auto">
        {/* Header */}
        <div className="bg-pv-blue text-white p-4 flex justify-between items-center">
        ...
        <div className="p-4 border-b border-pv-gray-300">
          {user ? (
            ...
            <Link
              href="/login"
              onClick={onClose}
              className="inline-block bg-pv-yellow text-pv-gray-900 font-bold px-4 py-2 rounded text-sm"
            >
              Sign In
            </Link>
          )}
